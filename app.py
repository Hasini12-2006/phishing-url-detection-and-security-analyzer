...
[data-testid="stAppViewContainer"] {
    background-image: url("https://ts2.mm.bing.net/th?id=OIP.VacDc_tTgQIIh64tooXJVwHaEv&pid=15.1");
    background-size: cover;
    background-repeat: no-repeat;
    background-attachment: fixed;
    color: grey; /* Bold grey font color */
    font-weight: bold;
...
# 📌 Step 3: Default message (so page isn’t blank)
if not url:
    st.info("ℹ️ Please enter a URL above and click 'Check URL'.")
